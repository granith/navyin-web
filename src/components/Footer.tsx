...
/**
 * Center Dock items — assets live in `public/dock/`.
 * TODO: set the real `href` for each (currently placeholders).
 */
const DOCK = [
  { id: 'consultants', src: '/dock/consultants.svg', labelKey: 'footer.dock.consultants', href: '#', separatorBefore: false },
  { id: 'teams', src: '/dock/teams.svg', labelKey: 'footer.dock.teams', href: '#', separatorBefore: false },
  { id: 'delivery', src: '/dock/delivery.svg', labelKey: 'footer.dock.delivery', href: '#', separatorBefore: false },
  { id: 'home', src: '/dock/home.svg', labelKey: 'footer.dock.home', href: '#', separatorBefore: true }
] as const;
